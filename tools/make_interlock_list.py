...
IL = [
    ...
    ("IL-5101A-02", "P-5101A", "START", "PERMISSIVE", "AND", "AUTO", "Y", 2,
     ...
     [("G1", "LIT-4003 > 25 %"),
      ...
      ("G1", "VFD FAULT 없음")],
     ""),
    ("IL-5101A-03", "P-5101A", "STOP", "SEQUENCE", "OR", "AUTO", "Y", 3,
     "SFC_P5101A_AUTO", "YI-Y01-C01-UW-LG-051", "2",
     [("G1", "LIT-4003 Low Low (10 %) 5sec (탱크 저수위)"),
      ("G1", "XV-5103 CLOSE 확인 3sec (토출 밸브 폐쇄, 체절운전 방지)")],
     "자동 운전 정지. 원인 해소 시 자동 재기동. 래치 없음."),
    ("IL-5101B-01", "P-5101B", "STOP", "INTERLOCK", "OR", "MANUAL", "N", 1,
     "FB_P5101B_ILK", "YI-Y01-C01-UW-LG-051", "3",
     [("G1", "MOTOR OVERLOAD TRIP (49)"),
      ("G1", "E-STOP PB 동작"),
      ("G1", "VFD FAULT 발생")],
     "기기 고장 보호. 래치되며 인터락 리셋으로만 해제. A호기와 동일 조건."),
    ("IL-5101B-02", "P-5101B", "START", "PERMISSIVE", "AND", "AUTO", "Y", 2,
     "FB_P5101B_PERM", "YI-Y01-C01-UW-LG-051", "3",
     [("G1", "LIT-4003 > 25 %"),
      ("G1", "XV-5103 OPEN 확인"),
      ("G1", "MCC READY 신호 정상"),
      ("G1", "VFD FAULT 없음"),
      ("G1", "P-5101A 정지 상태 (교대 운전)")],
     "예비 펌프. A호기 정지 시에만 기동."),
    ("IL-5101B-03", "P-5101B", "STOP", "SEQUENCE", "OR", "AUTO", "Y", 3,
     "SFC_P5101B_AUTO", "YI-Y01-C01-UW-LG-051", "3",
     [("G1", "LIT-4003 Low Low (10 %) 5sec (탱크 저수위)"),
      ("G1", "XV-5103 CLOSE 확인 3sec (토출 밸브 폐쇄, 체절운전 방지)")],
     "자동 운전 정지. 원인 해소 시 자동 재기동. 래치 없음."),
